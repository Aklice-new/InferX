...
TEST(SigmoidLayer, test1)
{
    SigmoidLayer sigmoid("sigmoid");
...
int main(int argc, char* argv[])
{
    ...
    inferx::read_data_from_txt("test/test_sigmoid/test_data/input.txt", input, 1 * 64 * 112 * 112);
    inferx::read_data_from_txt("test/test_sigmoid/test_data/output1.txt", output1, 1 * 64 * 112 * 112);
    inferx::read_data_from_txt("test/test_sigmoid/test_data/output2.txt", output2, 1 * 64 * 112 * 112);
    inferx::read_data_from_txt("test/test_sigmoid/test_data/output3.txt", output3, 1 * 64 * 112 * 112);
    inferx::read_data_from_txt("test/test_sigmoid/test_data/output4.txt", output4, 1 * 64 * 112 * 112);
