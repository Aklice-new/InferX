...
TEST(HardSigmoidLayer, test1)
{
    HardSigmoidLayer relu("hard_sigmoid");
...
TEST(HardSigmoidLayer, test2)
{
    HardSigmoidLayer relu("relu");
...
int main(int argc, char* argv[])
{
    ...
    inferx::read_data_from_txt("test/test_hardsigmoid/test_data/input.txt", input, 1 * 64 * 112 * 112);
    inferx::read_data_from_txt("test/test_hardsigmoid/test_data/output1.txt", output1, 1 * 64 * 112 * 112);
    inferx::read_data_from_txt("test/test_hardsigmoid/test_data/output2.txt", output2, 1 * 64 * 112 * 112);
    inferx::read_data_from_txt("test/test_hardsigmoid/test_data/output3.txt", output3, 1 * 64 * 112 * 112);
    inferx::read_data_from_txt("test/test_hardsigmoid/test_data/output4.txt", output4, 1 * 64 * 112 * 112);
