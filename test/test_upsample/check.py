...
# Upsample
m1 = torch.nn.Upsample(scale_factor=2, mode='nearest')
m2 = torch.nn.Upsample(scale_factor=3, mode='nearest')
m3 = torch.nn.Upsample(scale_factor=4, mode='nearest')
m4 = torch.nn.Upsample(scale_factor=5, mode='nearest')
